    ...
    var C = (function () {
        function e(t) {
          ...
          if (
            ...
            var M = function (e, t) {
                n.chunks.push({ pattern: e, alphabet: F(e), startIndex: t });
              },
              w = this.pattern.length;
            if (w > I) {
              for (var x = 0, _ = w % I, S = w - _; x < S; )
                M(this.pattern.substr(x, I), x), (x += I);
              if (_) {
                var O = w - I;
                  ...
                  var n = t.pattern,
                    ...
                    y = (function (e, t, n) {
                      ...
                      for (
                        ...
                        if (((x = Math.min(A, x)), (_ = b + k), S))
                          for (var F = 0; F < k; ) (O[b + F] = 1), (F += 1);
                      }
                      _ = -1;
                      for (
                        var C = [], N = 1, P = k + M, W = 1 << (k - 1), $ = 0;
                        $ < k;
                        $ += 1
                      ) {
                        for (var D = 0, K = P; D < K; )
                      ...
                      var V = { isMatch: _ >= 0, score: Math.max(0.001, N) };
                      if (S) {
                        var q = E(O, f);
        ...
        o(e, [
          {
            ...
            value: function (e, t) {
              ...
              this._myIndex =
                t ||
                A(this.options.keys, this._docs, {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                W(d, { ignoreFieldNorm: h }),
                c && d.sort(s),
                l(r) && r > -1 && (d = d.slice(0, r)),
                K(d, this._docs, { includeMatches: o, includeScore: a })
              );
            },
          },
          {
    ...
    return (
      ...
      (T.parseIndex = function (e) {
        var t =
          ...
          a = e.keys,
          c = e.records,
          s = new O({ getFn: r, fieldNormWeight: o });
